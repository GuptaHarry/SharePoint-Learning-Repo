...
export default class DisplaySiteDetailsWebPart extends BaseClientSideWebPart<IDisplaySiteDetailsWebPartProps> {
  ...
  public render(): void {
    ...
    <section class="${styles.displaySiteDetails} ${!!this.context.sdks.microsoftTeams ? styles.teams : ''}">
      <div class="${styles.welcome}">
        ...
        <div>Web part property value: <strong>${escape(this.properties.description)}</strong></div>
                ...
                <div class="${styles.displaySiteDetails}"> Absolute URL <strong>${escape(this.context.pageContext.web.absoluteUrl)}</strong></div>
               <div class="${styles.displaySiteDetails}">Title <strong>${escape(this.context.pageContext.web.title)}</strong></div>
